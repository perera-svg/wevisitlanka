...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: Field component intentionally uses role="group" on div for flexible composition
		<div
			role="group"
			data-slot="field"
	...
	const content = useMemo(() => {
		...
		return (
			<ul className="ml-4 flex list-disc flex-col gap-1">
				{uniqueErrors.map(
					(error, index) =>
						// biome-ignore lint/suspicious/noArrayIndexKey: error messages have no stable unique key
